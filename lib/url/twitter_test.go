...
func TestTwitter(t *testing.T) {
	for _, tt := range []struct {
		...
		},
		{
			...
			want: `There's a new #Arduino coming ! Have you seen it yet? http://ow.ly/xM7BJ http://nitter.net/pic/media/Bpx_nJpIMAEVd7M.png`,
		},
		{
			url:  "https://twitter.com/DefConBeanBag1/status/761690424423571456",
			want: "I want to break free... 🎵 ☠ #DEFCON2016 @defcon @thedarktangent http://nitter.net/pic/media/CpIRZDvUAAEOYm2.jpg",
		},
	} {
