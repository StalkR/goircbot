...
func TestTwitter(t *testing.T) {
	for _, tt := range []struct {
		...
		},
		{
			...
			want: `There's a new #Arduino coming ! Have you seen it yet? http://ow.ly/xM7BJ https://nitter.it/pic/enc/bWVkaWEvQnB4X25KcElNQUVWZDdNLnBuZw==`,
		},
		{
			url:  "https://twitter.com/DefConBeanBag1/status/761690424423571456",
			want: "I want to break free... 🎵 ☠ #DEFCON2016 @defcon @thedarktangent https://nitter.it/pic/enc/bWVkaWEvQ3BJUlpEdlVBQUVPWW0yLmpwZw==",
		},
	} {
