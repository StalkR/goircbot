...
type Bot interface {
	...
	Prefix() string                                           // Prefix returns the bot's command prefix
}
...
func WithPrefix(prefix string) func(impl *BotImpl) {
	return func(b *BotImpl) { b.prefix = prefix }
}
